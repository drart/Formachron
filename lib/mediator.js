...
var colours = ['red', 'orange', 'yellow', 'green', 'cyan', 'blue', 'purple', 'pink'];
...
class Mediator {
    ...
    sync(voiceNumber, sequenceIndex){
        ...
        // Build MIDI output messages (for hardware LED control)
        ...
        // Build control surface messages (for control surface API)
